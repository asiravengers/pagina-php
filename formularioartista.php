...
<head>
    ...
    <link rel="stylesheet" href="./css/formularioartista.css">
        ...
        <div class="right">
            <div class="container">
                ...
                <form action="#" method="POST" class="entradas-form">
                    ...
                    <div class="form-group">
                        <label for="entradas">Tipo de Artista</label>
                        <select id="entradas" name="entradas" required>
                            <option value="1">Starter Pack</option>
                            <option value="2">Artista Premium</option>
                            <option value="3">Artista Premium Pro</option>
                        </select>
                    </div>
